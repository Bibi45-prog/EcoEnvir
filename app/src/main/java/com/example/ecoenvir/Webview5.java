...
public class Webview5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.idWebView5);
        ...
        databaseReference = firebaseDatabase.getReference("news").child("url4");
    ...
    private void initializeWebView() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Webview5.this, "Fail to get URL.", Toast.LENGTH_SHORT).show();
            }
